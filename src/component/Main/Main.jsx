...
const Main = ({ track, onNext, onPrev }) => {
    ...
    <div className="main-wrapper">
      ...
      >
        ...
        <div className="main-details">
          ...
          {/* New: Prev and Next Buttons */}
          <div className="main-nav-buttons">
            <button style={{background:"black" ,border:'none ',marginLeft:"10px",marginRight:'5px'}} onClick={onPrev}>⏮️ </button>
            <button style={{background:"black" ,border:'none '}} onClick={onNext}>⏭️ </button>
          </div>
        </div>
      </div>
    </div>
